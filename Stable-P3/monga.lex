...
"void"			{ yylval.vInt = LEX_LineNumber; 	return TK_VOID; }
"char"			{ yylval.vInt = LEX_LineNumber; 	return TK_CHAR; }
"int"			{ yylval.vInt = LEX_LineNumber; 	return TK_INT; }
"float"			{ yylval.vInt = LEX_LineNumber; 	return TK_FLOAT; }
"if"			{ yylval.vInt = LEX_LineNumber; 	return TK_IF; }
"else"			{ yylval.vInt = LEX_LineNumber; 	return TK_ELSE; }
"while"			{ yylval.vInt = LEX_LineNumber; 	return TK_WHILE; }
"new"			{ yylval.vInt = LEX_LineNumber; 	return TK_NEW; }
"return"		{ yylval.vInt = LEX_LineNumber; 	return TK_RETURN; }
">="			{ yylval.vInt = LEX_LineNumber; 	return TK_GE; }
"<="			{ yylval.vInt = LEX_LineNumber; 	return TK_LE; }
"=="			{ yylval.vInt = LEX_LineNumber; 	return TK_CE; }
"&&"			{ yylval.vInt = LEX_LineNumber; 	return TK_AND; }
"||"			{ yylval.vInt = LEX_LineNumber; 	return TK_OR; }


[)(}{;[\]!=+\-*/><,] 	{ //]
						yylval.vInt = LEX_LineNumber;
						return yytext[0]; 
						}
